...
ALTER TABLE ne_110m_ocean DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_110m_lakes DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_50m_ocean DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_50m_lakes DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_50m_playas DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_10m_ocean DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_10m_lakes DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE ne_10m_playas DROP COLUMN IF EXISTS way_area;
...
ALTER TABLE water_polygons DROP COLUMN IF EXISTS way_area;
